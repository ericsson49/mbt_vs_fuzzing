...
Comparing structure-aware and random fuzzing using [v2](sloppy_vm_impl_v2.py) implementation with 100,000 tests:
...
By default, constants are sampled from `[0..UINT32_MAX]`. It makes it extremely unlikely to reveal [this bug](sloppy_vm_impl_v3.py#L72), since it requires the top stack element be exactly `7`.
...
## Implementation [v4](sloppy_vm_impl_v4.py) (no known bugs)
